$(document).ready(function() {
	...
	var Asteroid = function(x, y, radius, mass, vX, vY, aX, aY,fillstyle) {
		this.x = x;
		this.y = y;
		this.radius = radius;
	...
	for (var i = 0; i < 10; i++) {
		...
		asteroids.push(new Asteroid(x, y, radius, mass, vX, vY, aX, aY,fillstyle));
	...
	function animate() {
		...
		for (var i = 0; i < asteroidsLength; i++) {
			...
			context.fillStyle = tmpAsteroid.fillstyle;
			context.beginPath();
